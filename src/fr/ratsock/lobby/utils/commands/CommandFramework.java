...
public class CommandFramework implements CommandExecutor {
	...
	public boolean handleCommand(CommandSender sender, org.bukkit.command.Command cmd, String label, String[] args) {
		for (int i = args.length; i >= 0; i--) {
			...
			if (commandMap.containsKey(cmdLabel)) {
				...
				fr.ratsock.api.utils.commands.Command command = method.getAnnotation(fr.ratsock.api.utils.commands.Command.class);
	...
	public void registerCommands(Object obj) {
		for (Method m : obj.getClass().getMethods()) {
			if (m.getAnnotation(fr.ratsock.api.utils.commands.Command.class) != null) {
				fr.ratsock.api.utils.commands.Command command = m.getAnnotation(fr.ratsock.api.utils.commands.Command.class);
				if (m.getParameterTypes().length > 1 || m.getParameterTypes()[0] != fr.ratsock.api.utils.commands.CommandArgs.class) {
				...
				if (m.getParameterTypes().length > 1 || m.getParameterTypes().length == 0
						|| m.getParameterTypes()[0] != fr.ratsock.api.utils.commands.CommandArgs.class) {
	...
	public void registerCommand(fr.ratsock.api.utils.commands.Command command, String label, Method m, Object obj) {
